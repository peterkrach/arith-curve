...
$\varphi_p(E) = a_p(E) /2\sqrt p$, the numbers $\varphi_p(E)$ lie in the 
...
\begin{conjecture}
There exists a compact real Lie group $K$  in $GL(2g,\dC)$ such that 
$\widetilde P_{A_p}(x)$ are distributed like the characteristic polynomials of 
random matrices in $K$ (wrt. the Haar measure). 
\end{conjecture}

You can try to predict the $K$. Serre does this in his paper \cite{se94}. 
