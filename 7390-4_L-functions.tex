...
measure $\mu$. Let $\pi:K \to X$ be the canonical projection. Another way of 
stating Theorem \ref{thm:deuring-hecke} is that $\{\varphi_p\}\subset X$ is 
equidistributed with respect to the pushforward $\pi_\ast \mu$. 

To see this, note that the trace induces an isomorphism 
\[\xymatrix{
