...
meromorphic, then $\deg(f)\geqslant 0$, but the converse fails. 
...
an abelian variety $J$ with a morphism $j:C\to J$ taking $x_0$ to $0$, such 
...
rephrased as saying that $j:C\to A$ induces a natural isomorphism 
\[
...
$j:X\to \operatorname{Alb} X$ that induces a same natural isomorphism (with 
