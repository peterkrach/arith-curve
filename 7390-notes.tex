...
\[
  \h_S^1(k,A[n]) = \{[\varphi]\in \h^1(k,A[n]) : \varphi(I_\fp) = 0\text{ for all } \fp\in S\}
\]
is finite. 
...
Recall that $\sha(A)=\ker\left(\h^1(k,A) \to \prod_v \h^1(k_v,A)\right)$. 
...
(\textbf{discussion of restricted ramification, \'etale cohomology,\ldots})
