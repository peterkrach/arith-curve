...
Riemann-Roch theorem implies that $\chi(\mathscr{L}^n)$ is linear in $n$. The 
coefficient of $n$ is called the \emph{degree} of $\mathscr{L}$. Now, for $T$ 
an arbitrary scheme, define $\pic^\circ(C\times T)$ to be the subset of 
