...
$[n]^\ast D\sim n^2D$. (There are plenty of symmetric divisors: if $D$ is 
...
\[
  \widehat h_D(a) = \lim_{n\to \infty} \frac{1}{4^n} h_D(2^n\cdot a)
\]
(next time: show this limit exists,\ldots)
